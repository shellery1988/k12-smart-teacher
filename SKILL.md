...
displayName: K12智能老师
version: 1.0.1
description: K12智能老师辅导系统，支持作业批改、错题分析、举一反三练习生成。覆盖小学/初中/高中全学段，语文/数学/英语/物理/化学/生物/历史/地理/政治九大学科；数学专项题更丰富，其他学科提供基础模板练习。可生成Markdown/JSON练习文件，安装python-docx后可生成Word文档。
namespace: global
