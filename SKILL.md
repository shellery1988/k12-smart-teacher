...
displayName: K12智能老师
version: 1.0.2
description: K12智能老师辅导系统，支持作业批改、错题分析、举一反三练习生成。覆盖小学/初中/高中全学段，语文/数学/英语/物理/化学/生物/历史/地理/政治九大学科；数学和多个常见非数学主题提供专项练习模板。可生成Markdown/JSON练习文件，安装python-docx后可生成Word文档。
namespace: global
...
5. **非数学也能先用**：常见主题优先用专项模板；其他主题先生成基础模板，再提示可按教材或原题继续细化。
...
| 语文/英语练习生成 | 阅读理解、病句修改、现在完成时、一般过去时有专项模板；其他主题可用基础模板 | 先生成可用练习，再根据教材/题目材料细化 |
| 物理/化学/生物练习生成 | 浮力、化学方程式、细胞结构有专项模板；其他主题可用概念/实验模板 | 需要用户提供具体章节或错题材料时效果更好 |
| 历史/地理/政治练习生成 | 辛亥革命、气候类型、公民权利有专项模板；其他主题可用材料分析模板 | 需要结合教材版本、地区和时事材料时先询问 |
